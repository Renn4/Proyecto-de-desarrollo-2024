-- -----------------------------------------------------
-- SE NECESITA MYSQL WORKBENCH 8.0
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `mydb`.`ESTADO_CMA` (
  ...
  UNIQUE INDEX `id_estado_cma_UNIQUE` (`id_estado_cma` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`CMA` (
  ...
  PRIMARY KEY (`id_cma`),
  INDEX `fk_CMA_ASOCIADOS1_idx` (`usuarios_id` ASC) ,
  INDEX `fk_CMA2_ESTADO1_idx` (`estado_cma_id` ASC) ,
  UNIQUE INDEX `id_cma_UNIQUE` (`id_cma` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPOS_LICENCIAS` (
  ...
  UNIQUE INDEX `id_tipo_licencias_UNIQUE` (`id_tipo_licencias` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`LICENCIAS` (
  ...
  INDEX `fk_LICENCIAS_ASOCIADOS_idx` (`usuarios_id` ASC) ,
  INDEX `fk_LICENCIAS2_TIPO_LICENCIAS1_idx` (`tipo_licencias_id` ASC) ,
  UNIQUE INDEX `id_licencias_UNIQUE` (`id_licencias` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPO_RECIBOS` (
  ...
  UNIQUE INDEX `id_tipo_recibos_UNIQUE` (`id_tipo_recibos` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`CUENTA_CORRIENTE` (
  ...
  INDEX `fk_SALDOS_USUARIOS11_idx` (`usuarios_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TRANSACCIONES` (
  ...
  INDEX `fk_TRANSACCIONES_TIPO_PAGO1_idx` (`tipo_pago_id` ASC) ,
  UNIQUE INDEX `id_transacciones_UNIQUE` (`id_transacciones` ASC) ,
  INDEX `fk_TRANSACCIONES_CUENTA_CORRIENTE1_idx` (`cuenta_corriente_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`RECIBOS` (
  ...
  UNIQUE INDEX `id_recibos_UNIQUE` (`id_recibos` ASC) ,
  INDEX `fk_RECIBOS_TIPO_RECIBOS1_idx` (`tipo_recibos_id` ASC) ,
  INDEX `fk_RECIBOS_TRANSACCIONES1_idx` (`transacciones_id` ASC) ,
  UNIQUE INDEX `numero_recibos_UNIQUE` (`numero_recibos` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`ESTADOS_AERONAVES` (
  ...
  UNIQUE INDEX `id_estados_aeronaves_UNIQUE` (`id_estados_aeronaves` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`AERONAVES` (
  ...
  INDEX `fk_AERONAVES_ESTADOS_AERONAVES1_idx` (`estados_aeronaves_id` ASC) ,
  UNIQUE INDEX `id_aeronaves_UNIQUE` (`id_aeronaves` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`COMPONENTES_AERONAVES` (
  ...
  INDEX `fk_MOTORES_AERONAVES1_idx` (`aeronaves_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPO_ITINERARIOS` (
  ...
  UNIQUE INDEX `id_tipo_itinerarios_UNIQUE` (`id_tipo_itinerarios` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`ITINERARIOS` (
  ...
  INDEX `fk_ITINERARIOS2_TIPO_ITINERARIOS1_idx` (`tipo_itinerarios_id` ASC) ,
  INDEX `fk_ITINERARIOS_AERONAVES1_idx` (`aeronaves_id` ASC) ,
  UNIQUE INDEX `id_itinerarios_UNIQUE` (`id_itinerarios` ASC) ,
  INDEX `fk_ITINERARIOS_RECIBOS1_idx` (`RECIBOS_id_recibos` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPOS_HABILITACIONES` (
  ...
  UNIQUE INDEX `id_tipo_habilitaciones_UNIQUE` (`id_tipo_habilitaciones` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`HABILITACIONES` (
  ...
  INDEX `fk_HABILITACIONES_ASOCIADOS1_idx` (`usuarios_id` ASC) ,
  INDEX `fk_HABILITACIONES2_TIPO_HABILITACION1_idx` (`tipo_habilitaciones_id` ASC) ,
  UNIQUE INDEX `id_habilitaciones_UNIQUE` (`id_habilitaciones` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`MEDIDAS` (
  ...
  UNIQUE INDEX `id_medidas_UNIQUE` (`id_medidas` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`PRODUCTOS` (
  ...
  INDEX `fk_PRODUCTOS_MEDIDAS1_idx` (`medidas_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`USUARIOS_tiene_ROLES` (
  ...
  INDEX `fk_USUARIOS_has_ROLES_USUARIOS1_idx` (`usuarios_id` ASC) ,
  PRIMARY KEY (`id_usuarios_tiene_roles`),
  UNIQUE INDEX `id_usuarios_tiene_roles_UNIQUE` (`id_usuarios_tiene_roles` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TARIFAS` (
  ...
  INDEX `fk_TARIFAS_AERONAVES21_idx` (`aeronaves_id` ASC) ,
  UNIQUE INDEX `id_tarifas_UNIQUE` (`id_tarifas` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CUOTAS_SOCIALES` (
  ...
  UNIQUE INDEX `id_cuotas_sociales_UNIQUE` (`id_cuotas_sociales` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`NOTAS_VUELOS` (
  ...
  INDEX `fk_NOTAS_VUELOS2_USUARIOS11_idx` (`instructores_id` ASC) ,
  INDEX `fk_NOTAS_VUELOS_USUARIOS11_idx` (`asociados_id` ASC) ,
  UNIQUE INDEX `id_notas_vuelos_UNIQUE` (`id_notas_vuelos` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`DATOS_HISTORICOS` (
  ...
  INDEX `fk_CARGAR_DATOS_USUARIOS11_idx` (`usuarios_id` ASC) ,
  UNIQUE INDEX `id_datos_historicos_UNIQUE` (`id_datos_historicos` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CODIGOS_AEROPUERTOS` (
  ...
  UNIQUE INDEX `id_codigos_aeropuertos_UNIQUE` (`id_codigos_aeropuertos` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`ITINERARIOS_tienen_CODIGOS_AEROPUERTOS` (
  ...
  INDEX `fk_ITINERARIOS2_has_codigos_aeropuertos_codigos_aeropuertos_idx` (`codigos_aeropuertos_id` ASC) ,
  INDEX `fk_ITINERARIOS2_has_codigos_aeropuertos_ITINERARIOS21_idx` (`itinerarios_id` ASC) ,
  PRIMARY KEY (`id_itinerarios_tienen_codigos`),
  UNIQUE INDEX `id_itinerarios_tienen_codigos_UNIQUE` (`id_itinerarios_tienen_codigos` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`MOVIMIENTOS` (
  ...
  INDEX `fk_MOVIMIENTOS_PRODUCTOS1_idx` (`productos_id` ASC) ,
  INDEX `fk_MOVIMIENTOS_USUARIOS1_idx` (`usuarios_id` ASC) ,
  UNIQUE INDEX `id_movimientos_UNIQUE` (`id_movimientos` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`REPORTES` (
  ...
  INDEX `fk_REPORTES_AERONAVES1_idx` (`aeronaves_id` ASC) ,
  UNIQUE INDEX `id_reportes_UNIQUE` (`id_reportes` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPO_CUOTAS_SOCIALES` (
  ...
  INDEX `fk_TIPO_CUOTA_SOCIALES_CUOTAS_SOCIALES1_idx` (`cuotas_sociales_id` ASC) ,
  UNIQUE INDEX `id_tipo_cuotas_sociales_UNIQUE` (`id_tipo_cuotas_sociales` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`USUARIOS_pago_CUOTAS_SOCIALES` (
  ...
  `usuarios_id` INT NOT NULL,
  `cuotas_sociales_id` INT NOT NULL,
  INDEX `fk_USUARIOS_has_CUOTAS_SOCIALES_CUOTAS_SOCIALES1_idx` (`cuotas_sociales_id` ASC) ,
  INDEX `fk_USUARIOS_has_CUOTAS_SOCIALES_USUARIOS1_idx` (`usuarios_id` ASC) ,
  PRIMARY KEY (`id_usuarios_pago_cuota_social`),
  UNIQUE INDEX `id_usuarios_pago_cuota_social_UNIQUE` (`id_usuarios_pago_cuota_social` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`SEGUROS` (
  ...
  INDEX `fk_SEGUROS_AERONAVES1_idx` (`aeronaves_id` ASC) ,
  UNIQUE INDEX `id_seguros_UNIQUE` (`id_seguros` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`USUARIOS_tienen_RECIBOS` (
  ...
  INDEX `fk_USUARIOS_has_VUELOS_RECIBOS_VUELOS_RECIBOS1_idx` (`recibos_id` ASC) ,
  PRIMARY KEY (`id_usuarios_tienen_recibos`),
  UNIQUE INDEX `id_usuarios_tienen_recibos_UNIQUE` (`id_usuarios_tienen_recibos` ASC) ,
  INDEX `fk_USUARIOS_tienen_RECIBOS_USUARIOS1_idx` (`usuarios_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CUENTA_CORRIENTE_HORAS` (
  ...
  INDEX `fk_CUENTA_CORRIENTE_HORAS_USUARIOS1_idx` (`usuarios_id` ASC) ,
  UNIQUE INDEX `id_cuenta_corriente_horas_UNIQUE` (`id_cuenta_corriente_horas` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`OPERACIONES` (
  ...
  INDEX `fk_MOVIMIENTOS_HORA_VUELO_CUENTA_CORRIENTE_HORAS_ADELANTADA_idx` (`cuenta_corriente_horas_id` ASC) ,
  INDEX `fk_OPERACIONES_AERONAVES1_idx` (`aeronaves_id` ASC) ,
  UNIQUE INDEX `id_operaciones_UNIQUE` (`id_operaciones` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TARIFA_ESPECIAL` (
  ...
  INDEX `fk_TARIFA_ESPECIAL_USUARIOS1_idx` (`usuarios_id` ASC) ,
  UNIQUE INDEX `id_tarifa_especial_UNIQUE` (`id_tarifa_especial` ASC) ,
